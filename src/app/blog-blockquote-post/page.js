                        ...
                        <div className="card blog blog-primary text-center border-0">
                            <div className="bg-soft-primary p-4 rounded shadow">
                                ...
                                <div className="py-4 px-lg-4 my-2">
                                    <p className="text-dark fst-italic h5 mb-0">“ Im selfish, impatient and a little insecure. I make mistakes, I am out of control and at times hard to handle. But if you cant handle me at my worst, then you sure as hell dont deserve me at my best. ”</p>
