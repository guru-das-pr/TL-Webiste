            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 col-lg-8">
                        <Image src='/images/portfolio/single01.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid rounded shadow" alt=""/>
                    
                        <Image src='/images/portfolio/single02.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid rounded shadow mt-4" alt=""/>
                    
                        <Image src='/images/portfolio/single03.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid rounded shadow mt-4" alt=""/>
